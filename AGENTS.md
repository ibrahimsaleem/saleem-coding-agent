...
Docs accompany every code change: update affected README and JSDoc contracts together. Documentation rules follow [docs/AGENTS.md](docs/AGENTS.md). Current-state prose, one physical line per paragraph, one home per fact, and word budgets live there.
