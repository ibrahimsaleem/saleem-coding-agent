...
Service instances, Event payloads, Slot props, Session and Conversation Snapshots, Tool state, and other Cordis/Saleem Harness objects are internal live data.
