...
Service instances, Event payloads, Slot props, Session and Conversation Snapshots, Tool state, and other Cordis/Saleem Meta Harness objects are internal live data.
