...
describe('LayoutController', () => {
  it('forwards the panel actions to the attached set', () => {
    ...
    expect(panels.openTree).toHaveBeenCalledTimes(1)
    expect(panels.closeTree).toHaveBeenCalledTimes(1)
  ...
  it('fails loud before the root entry wired its actions', () => {
    ...
    expect(() => { service.openTree() }).toThrow(/panel actions not wired/)
    expect(() => { service.closeTree() }).toThrow(/panel actions not wired/)
  })
