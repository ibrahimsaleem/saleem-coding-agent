...
export const en = {
  ...
  onboardingTitle: 'Add any API key to get started',
  onboardingDescription: 'Configure any provider’s API key to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingTitle: '添加任意 API Key 开始使用',
  onboardingDescription: '配置任意提供方的 API 密钥，即可开始使用。',
