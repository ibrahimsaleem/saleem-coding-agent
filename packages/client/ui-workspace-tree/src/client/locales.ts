...
export const zh = {
  ...
  loading: '加载中…',
  empty: '空文件夹',
  truncated: '仅显示前 {count} 项',
  noMatch: '无匹配项',
  collapse: '收起文件树',
  filter: '搜索文件…',
  clearFilter: '清除搜索',
  searching: '搜索中…',
  searchTruncated: '结果过多，仅显示部分匹配项——请输入更精确的关键字',
...
export const en: { [Key in WorkspaceTreeKey]: string } = {
  ...
  loading: 'Loading…',
  empty: 'Empty folder',
  truncated: 'Showing the first {count} items',
  noMatch: 'No matches',
  collapse: 'Collapse file tree',
  filter: 'Search files…',
  clearFilter: 'Clear search',
  searching: 'Searching…',
  searchTruncated: 'Too many results to show all — try a more specific search',
