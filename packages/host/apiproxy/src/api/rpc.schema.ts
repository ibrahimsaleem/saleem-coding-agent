...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('harness-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('harness-generation-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('monitor-session-not-found'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
